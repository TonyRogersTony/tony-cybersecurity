        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 mb-12">
            <p className="text-lg text-slate-700 leading-relaxed mb-6">
              With a dual role as a <strong className="text-green-600">Solutions & Migrations Engineer</strong> and a <strong className="text-orange-600">Health Coach</strong>, my career is a testament to versatility and a dedication to empowering others through technology and wellness. I have a proven track record in streamlining deployment processes, resolving critical issues, and building strong client relationships.
            </p>
            ...
            {highlights.map((item, index) => {
              ...
              return (
                <Card key={index} className="p-6 hover:shadow-lg transition-shadow border-t-4 border-t-green-500">
                  <div className="w-12 h-12 bg-gradient-to-br from-green-100 to-orange-100 rounded-lg flex items-center justify-center mb-4">
