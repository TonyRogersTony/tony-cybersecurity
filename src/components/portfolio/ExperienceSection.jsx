    ...
    <section id="experience" className="py-20 bg-slate-50">
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="w-20 h-1 bg-gradient-to-r from-green-600 to-orange-500 mx-auto mb-12"></div>

          <div className="space-y-6">
            {experiences.map((exp, index) => (
              <Card key={index} className="p-6 md:p-8 hover:shadow-xl transition-all duration-300 border-l-4 border-l-green-500">
          ...
          <Card className="mt-8 p-6 md:p-8 bg-gradient-to-r from-orange-50 to-green-50">
            <h3 className="text-2xl font-bold text-slate-800 mb-4">Early Career Highlights</h3>
            <div className="grid md:grid-cols-2 gap-4 text-slate-700">
              <div>
                <strong className="text-green-600">O2 (2003–2005):</strong> Managed CriticalPath SMS Gateway on O2's SMS platform using Sun Cluster and SAN/NAS storage.
              </div>
              <div>
                <strong className="text-green-600">Cap Gemini (2002–2003):</strong> Applications Integrator performing performance tuning on Enterprise systems.
              </div>
              <div>
                <strong className="text-orange-600">Genie / BTCellnet (2001–2002):</strong> Implemented UK/Europe SMS solutions and managed Openwave WAP Portals.
              </div>
              <div>
                <strong className="text-orange-600">BTCellnet (1998–2000):</strong> Managed over 300 mission-critical Enterprise Systems using Solaris and Jumpstart.
              </div>
            </div>
          </Card>
        </div>
