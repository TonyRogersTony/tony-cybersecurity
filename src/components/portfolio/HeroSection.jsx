...
export default function HeroSection({ onContactClick }) {
  ...
  return (
    <header id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20" style={{ color: 'var(--text-primary)', backgroundColor: 'var(--bg-primary)' }}>
